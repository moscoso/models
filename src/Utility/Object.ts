...
export class ObjectUtility {
	/**
	 * Modifies a numeric property of objects within a given map. This function can access and modify
	 * both direct and nested numeric properties based on the provided property path. If the property
	 * at the specified path is not a number, or if the object does not exist, the function throws an error.
	 *
